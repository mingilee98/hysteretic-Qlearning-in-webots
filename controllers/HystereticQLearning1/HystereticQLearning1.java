...
public class HystereticQLearning1 {
    ...
    public static void main(String[] args) {
        ...
        HystereticQLearning1 agent = new HystereticQLearning1();
        agent.initializeQ(2);
        ...
        for (int t = 0; t < 3000; t++) {
            ...
            if (action == 1) {
                System.out.println("agent2: stay");
                currentTime += 2.0;
                // backward
                ...
                System.out.println("agent2: move forward");
                currentTime += 2.0;
                // forward
                while (robot.step(TIME_STEP) != -1 && (robot.getTime() < currentTime)) {
            ...
            System.out.println("Agent2 trial " + t);
        ...
        System.out.println("agent 2 Qtable:");
        for (double q : agent.Q) {
            System.out.print(q + " ");
        }
        System.out.println();
        System.out.println("agent 2 rewards:");
